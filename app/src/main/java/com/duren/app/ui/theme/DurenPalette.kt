...
val DarkDurenPalette = DurenPalette(
    ...
    GlassStrong = DurenColors.GlassStrong,
    GlassBorder = DurenColors.GlassBorder,
...
val LightDurenPalette = DurenPalette(
    ...
    Glass = DurenColorsLight.Glass,
    GlassStrong = DurenColorsLight.GlassStrong,
    GlassBorder = DurenColorsLight.GlassBorder,
